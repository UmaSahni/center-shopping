...
import { useRegisterMutation, useGoogleAuthMutation } from '../../redux/services/api.js';
  ...
  const handleGoogleSignUp = async () => {
    ...
    try {
      ...
      if (err?.code !== 'auth/popup-closed-by-user') {
        const msg = err?.data?.message || err?.message || 'Google sign-up failed. Please try again.';
        setErrorMsg(msg);
